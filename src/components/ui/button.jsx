  ...
  "inline-flex items-center justify-center gap-2.5 whitespace-nowrap font-medium transition-all duration-200 ease-out disabled:pointer-events-none disabled:opacity-60 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500 relative overflow-hidden group active:scale-[0.98] transform-gpu select-none",
  {
    variants: {
      variant: {
        ...
        link: 
          "text-blue-600 hover:text-blue-700 underline-offset-4 hover:underline rounded-lg dark:text-blue-400 dark:hover:text-blue-300",
        ...
        // Soft - Pastel colors
        soft:
          "bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-700 shadow-sm hover:shadow-lg hover:from-blue-200 hover:to-indigo-200 hover:-translate-y-0.5 border border-blue-200/50 rounded-xl dark:from-blue-900/30 dark:to-indigo-900/30 dark:text-blue-300 dark:border-blue-800/30",
      },
      size: {
