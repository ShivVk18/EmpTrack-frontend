...
export default function MyProfileCard() {
  ...
  return (
    <div className="min-h-screen  py-10 px-4">
      <Card className="max-w-xl mx-auto rounded-2xl  backdrop-blur-sm shadow-[0_4px_20px_rgba(12,10,9,0.06)] hover:shadow-[0_8px_24px_rgba(12,10,9,0.08)] transition-shadow duration-300">
        <CardHeader className="flex items-center justify-between">
          ...
          {isAdmin && (
            <Button
              ...
              size="sm"
              onClick={handleEdit}
              className="gap-1 bg-gradient-to-r from-amber-500 to-amber-700 text-white hover:from-amber-600 hover:to-amber-800 transition-colors"
            >
